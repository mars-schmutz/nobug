...
class Command(Enum):
    ...
    These map onto the pdb/gdb stepping verbs. Anything that doesn't resume
    execution (setting a breakpoint, adding a watch, evaluating an expression)
    is applied to shared state directly and never flows through here.
    """
